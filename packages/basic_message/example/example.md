[English](https://github.com/huanguan1978/messages/blob/master/packages/basic_message/doc/en/EXAMPLE.md) | [Chinese
](https://github.com/huanguan1978/messages/blob/master/packages/basic_message/doc/zh/EXAMPLE.md)
...
Define your messages in a shared package, adhering to the [Naming Convention](https://github.com/huanguan1978/messages/blob/master/packages/basic_message/doc/en/I18N_NAMING_GUIDE.md).
...
*Tip: Use `[ft:FileTools](https://pub.dev/packages/filetools)` with `ft-messages-multilanguage.yaml` for full automation of this pipeline.*

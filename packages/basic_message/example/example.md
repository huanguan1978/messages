...
Define your messages in a shared package, adhering to the [Naming Convention](https://github.com/huanguan1978/messages/blob/main/packages/basic_message/doc/en/L10N_NAMING_GUIDE.md).
